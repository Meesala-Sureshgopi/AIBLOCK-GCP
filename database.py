...
cred = credentials.Certificate("AIBLOCK.json")
...
#     requests.get("Link to the cloud function", params=params)
#     return

# def get_data():
#     params={"query":"get"}
#     params=urlencode(params)
#     data=requests.get("Link to the cloud function", params=params)
